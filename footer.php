<footer class="page-footer" style="margin-top: 120px; box-shadow: 0px 0px 2px white; background-color: rgb(17,17,17)">
  <div class="row wide-container">
    <div class="col s3">
      <h4 class="white-text bold underline">TechLux Hub</h4>
    ...
    <div class="col s2">
      ...
      <p class="bold">
        #127-128,<br>
        Mysuru - Bannur Road Post,<br> Alanahalli, Mysuru, 570028.
      </p>
    </div>
    <div class="col s2">
      <h5 class="white-text bold">Social</h5>
      <a class="white-text bold" style="margin: 2px;">
  ...
  <div class="footer-copyright" style="padding-bottom: 20px;">
    <div class="wide-container underline">© 2024 TechLux Hub All rights reserved.</div>
  </div>````
